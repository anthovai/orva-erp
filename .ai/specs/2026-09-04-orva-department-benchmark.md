...
4. Expense claims: one screen — date, payee, amount, VAT?, WHT?, category account, receipt image — posts the journal and appears in ภ.พ.30/ภ.ง.ด. registers.
5. Helpdesk-lite: tickets linked to customer companies with status, priority, due date, notes; list + detail; surfaces open tickets on the home screen.
