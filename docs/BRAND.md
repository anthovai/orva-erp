...
| สคริปต์ | ฟอนต์ | หมายเหตุ |
|---|---|---|
| ไทย | **IBM Plex Sans Thai** (ปัจจุบัน) หรือ Anuphan | ทั้งคู่เป็น grotesk สมัยใหม่ ตัดกลิ่นราชการ |
| ละติน | Geist หรือ Inter (ผ่าน next/font) | ตกลงเลือกตัวเดียวแล้วใช้ทั้งระบบ |

ที่ใช้อยู่: `IBM_Plex_Sans_Thai` (next/font/google) บนหน้า marketing —
ครอบคลุมละตินในตัว ยังไม่จำเป็นต้องแยกคู่ฟอนต์จนกว่าจะทำ brand refresh รอบใหญ่
