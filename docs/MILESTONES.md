...
>
> **ขอบเขตที่ตัดออกอย่างตั้งใจ:**
> - **Email channel ไม่ส่งจริง** — แค่บันทึกแถว `notifications` ไว้ (log บอกว่า "queued") ไม่มี SMTP client ต่อจริง เพราะยังไม่ตัดสินใจเรื่อง email provider — เก็บเป็นงานค้างชัดเจน
